...
# import your utils + Drive paths from config
from cookbooks.preprocess.pos.utils import process_sales_data_from_pdf_text
from cookbooks.config import POS_PDF_DIR, POS_OUT_DIR

pdf_folder = POS_PDF_DIR  # Drive folder with POS PDFs
...
if all_clean_dfs:
    ...
    preprocessed_folder = POS_OUT_DIR
    if not os.path.exists(preprocessed_folder):
        os.makedirs(preprocessed_folder)
    
    output_file = os.path.join(preprocessed_folder, "sales.csv")
