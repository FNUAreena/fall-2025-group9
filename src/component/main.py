...
# Make sure we use the updated utils in notebook environments
...
# ---- Load & aggregate district-by-date series (robust + autodetect)
...
if len(values) <= WINDOW + 1:
    raise ValueError(f"Series too short (N={len(values)}). Need at least 3 daily points.")
